<template>
  <div class="content">
    <h1>个人信息</h1>
    <el-form :model="user" label-width="100px" class="form" style="max-width: 600px">
      <!-- 管理员ID -->
      <el-form-item label="管理员ID">
        <el-input v-model="user.adminID" disabled />
      </el-form-item>
      ...
      <el-form-item label="密码">
        <el-input v-model="user.passwords" :type="addPassFlag ? 'text' : 'password'">
          <template #suffix>
      ...
      <el-form-item label="年龄">
        <el-input v-model="user.age" type="number" min="0" />
      </el-form-item>

      <!-- 邮箱 -->
      <el-form-item label="邮箱">
        <el-input v-model="user.mail" disabled />
      </el-form-item>
